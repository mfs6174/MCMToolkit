...
[m,t]=size(myline);
for i=1:m
   plot([pnt(myline(i,1),1) pnt(myline(i,2),1)],[pnt(myline(i,1),2) pnt(myline(i,2),2)]);%画点连线
end
%for i=1:10
%    plot([200/11*i 200/11*i],[0 100],'--');%画网格 200 100是长宽 11是分区
%    plot([0 200],[100/11*i 100/11*i],'--');
%end
x=152.5 ;y=57.5;%用中心点和半边长画矩形框
yy=min(y+12.5,100);
